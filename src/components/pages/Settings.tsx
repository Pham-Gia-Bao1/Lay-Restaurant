        ...
        {loading ? (
          ...
          <>
            <div className="flex items-center justify-between w-screen overflow-hidden pr-14 sm:pr-0 sm:w-full m-2 ml-0  flex-wrap">
              <div
                className={`${theme} flex items-center justify-between py-6 sm:py-16 bg-blue-500  flex-wrap`}
              >
            ...
            <div className="flex justify-between mb-4 flex-wrap gap-3">
              <div className="scroll-container p-2 flex sm:gap-3 gap-1.5 justify-center items-center">
                <button
                  type="button"
                ...
                {uniqueTypes.map((type, index) => (
                  <button
                    type="button"
                    key={index}
                    className={`${theme} box-shadow px-4 min-w-fit py-2 active:bg-red-500 hover:bg-gray-800 rounded`}
